...
export default function UserDashboard() {
  ...
  const fetchAcceptMessages = useCallback(async () => {
    ...
    try {
      ...
      console.error("Error while fetching is accepting Messages: ", error)
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      console.error("Error while handling changing of switch: ", error)
      const axiosError = error as AxiosError<ApiResponse>
  ...
  return (
    <div className="overflow-hidden my-8 mx-0 md:mx-0 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
